...
import { updateElementProperty, removeFromElements, setCurrentElementId } from '../../utils/slices/pageSlice';
const ImageProperties = ({ id, type, src, width, height }) => {
    ...
    return (
        <div className='flex'>
            <ul className='flex space-x-2 mt-2 ml-3'>
                ...
                <li>
                    <input ref={srcRef} className='cursor-pointer p-1 text-center hover:border-2 rounded-lg hover:border-purple-400   border-1 border-gray-200' type='text' placeholder='Change Image Source' />
                </li>
                <li>
                    <button
